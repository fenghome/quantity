...
export const getRouterData = app => {
  const routerConfig = {
    ...
    '/quantity/list':{
      component: dynamicWrapper(app, ['quantity'], () => import('../components/Quantity/QuantityList.js')),
    },
    '/quantity/add':{
      name:'新增',
    ...
    '/quantity/search':{
      name:'查询',
      component:dynamicWrapper(app,['quantity'],()=>import('../components/Quantity/QuantitySearch.js')),
    },
    '/company': {
      component: dynamicWrapper(app, ['company'], () => import('../routes/Company')),
    },
    '/employee': {
      component: dynamicWrapper(app, ['employee'], () => import('../routes/Employee')),
    },
    '/test': {
